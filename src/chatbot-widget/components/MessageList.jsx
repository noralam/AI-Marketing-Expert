...
const MessageList = ( { messages, isTyping, readReceiptId } ) => {
	...
	return (
		<div className="aime-chat-messages" ref={ listRef } onScroll={ handleScroll } role="log" aria-live="polite">
			...
			{ isTyping && (
				<div className="aime-chat-msg aime-chat-msg--bot" role="status" aria-label="Assistant is typing">
					<div className="aime-chat-msg-avatar" aria-hidden="true">
					...
					<div className="aime-chat-typing-dots" aria-hidden="true">
